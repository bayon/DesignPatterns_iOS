...
//You also need to call this method when you add HorizontalScroller to another view.
//Add the following code to HorizontalScroller.m to cover the latter scenario:
